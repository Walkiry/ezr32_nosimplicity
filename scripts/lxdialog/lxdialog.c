 ...
 *  MODIFIED FOR NSS  CONFIG BY: Alexandre Malki (alexandremalki@gmail.com)
 *
...
\n  modified/gutted for use as a board kernel config tool by \
\n  Alexandre MALKI (alexandremalki@gmail.com)\ 
\n\
